...
export const createProductController = async (req, res) => {
  try {
    ...
    switch (true) {
      ...
      case !description:
        return res.status(500).send({ error: "La descripción es requerida" });
      case !price:
      ...
      case !photo && size > 2000000:
        return res
          .status(500)
          .send({ error: "La imagen es requerida y debe pesar menos de 2mb" });
    }
  ...
  try {
    ...
    switch (true) {
      ...
      case photo && photo.size > 2000000:
        return res
          .status(500)
          .send({ error: "Foto es requerida y debe pesar menos de 2mb" });
    }
